...
export default function Destination() {
  ...
  return (
    <div className="destBody">
      ...
      <div className="flex flex-wrap gap-6 px-[33px] mt-20 justify-between">
        {tripDetails.map((item, index) => {
          return (
            <div
              key={index}
              className="w-[445px] border-[2px] border-grayCustom2 rounded-3xl overflow-hidden"
            >
              ...
              <div className="px-[23px] relative m-0 p-0">
                <h4 className="boldFontFamily text-black text-xl mt-7">
                  {item?.title}
                </h4>
                <div className="flex mt-2">
                  <div className="flex justify-center items-center">
                    <img src={nights} alt="night" />
                    <p className="meduimFontFamily text-black text-base ml-2">{`${item.nights} Nights`}</p>
                  </div>

                  <div className="flex justify-center items-center ml-5">
                    <img src={days} alt="day" />
                    <p className="meduimFontFamily text-black text-base ml-2">{`${item.days} Days`}</p>
                  </div>
                </div>
                <h4 className="meduimFontFamily text-lg text-black mt-2">
                  {item?.includedText}
                </h4>
                ...
                <div className="flex flex-wrap gap-4 mt-2">
                  {item?.transport && (
                    <div className="flex justify-center items-center">
                      ...
                      <p className="meduimFontFamily text-black text-base ml-2">
                        Transfers
                      </p>
                    </div>
                  )}
                ...
                <div className="flex justify-between items-center py-3 border-t-[1.8px] mt-4 border-grayCustom2">
                  <button
                    className="py-[9px] px-[30px] bg-skyBule rounded-full text-white regularFontFamily text-sms"
