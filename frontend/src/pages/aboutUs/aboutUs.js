  ...
  return (
    <div className="aboutBody">
      <div className="aboutBannerBody">
            <div  className="aboutBanner">
              ...
              <div className="aboutContent">
                ...
                <p className="subHeaderText mediumFontFamily">
      ...
      <div className="middleContentBodyTwo">
        <h1 className="extraBoldFontFamily leading-[62.4px] text-5xl  leading-none">
          Our Vision{" "}
        </h1>
        <p className="regularFontFamily leading-[18.2px] text-[24px] mt-5 leading-none">
