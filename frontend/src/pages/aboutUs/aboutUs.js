  ...
  return (
    <div className="aboutBody">
      ...
      <div className="middleContentBody container mx-auto ">
        ...
        <p className="regularFontFamily  text-xs md:text-[16px] leading-[24px] px-4 md:px-24 mt-6 text-center">
      ...
      <div className="container mx-auto px-3 md:px-0">
        ...
        <p className="regularFontFamily text-xs md:text-base leading-[24px] mt-6 text-center px-4 md:px-24 ">
      ...
      <div className="rounded-lg h-fit  mt-[80px]">
        <div className="flex  flex-col md:flex-row justify-between gap-4 p-4 lg:p-8">
          <div className=" flex flex-col md:w-[50%] md:px-16  justify-center">
      ...
      <div className="rounded-lg h-fit mt-[80px]">
        <div className="flex flex-col md:flex-row-reverse gap-4 justify-between p-4 lg:p-8">
      ...
      <div className="bg-skyBlue100 rounded-lg  mt-[80px]">
        <div className="flex flex-col lg:flex-row gap-4 justify-between p-4 lg:p-8">
          ...
          <div className="w-full lg:w-1/2 lg:px-16 px-0 flex flex-col justify-center">
